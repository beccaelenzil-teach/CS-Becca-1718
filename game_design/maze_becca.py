...
NATIVE_SPRITE_SIZE = 500
SPRITE_SCALING = 0.05
SPRITE_PLAYER_SCALING = 0.025
...
class MyApplication(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("spy.png", SPRITE_PLAYER_SCALING)
        ...
        for row in range(MAZE_HEIGHT):
            for column in range(MAZE_WIDTH):
                if maze[row][column]:
                    wall = arcade.Sprite("black_square.png", SPRITE_SCALING)
